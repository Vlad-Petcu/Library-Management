...
public class Signup extends JFrame implements ActionListener {
	...
	public Signup() {
		...
		textField_1.setBounds(265, 91, 148, 20);
		contentPane.add(textField_1);

		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(265, 128, 148, 20);
		contentPane.add(textField_2);

		textField_3 = new JTextField();
		textField_3.setColumns(10);
		textField_3.setBounds(265, 165, 148, 20);
		...
		textField_5.setBounds(265, 202, 148, 20);
		...
		panel.setBorder(new TitledBorder(new LineBorder(new Color(67, 229, 247), 2), "",
	...
	public void actionPerformed(ActionEvent ae) {
		try {
			...
			if (ae.getSource() == b1) {
				String sql = "insert into account(username, name, password, sec_ans, sec_q) values(?, ?, ?, ?, ?)";
